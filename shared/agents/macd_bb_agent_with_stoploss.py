...
class MACDBBAgentWithStopLoss(MACDBBAgent):
    """
    損失確定機能（パーセンテージベース）とトレーリングストップロス（利益確定）機能付き
    MACD+ボリンジャーバンドエージェント
    """
    ...
    def __init__(
        ...
        初期化
        """
        super().__init__(agent_id, trader_id, macd_fast, macd_slow, macd_signal,
                        bb_period, bb_num_std_dev)
