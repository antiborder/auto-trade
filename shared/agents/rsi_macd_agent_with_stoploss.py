...
class RSIMACDAgentWithStopLoss(RSIMACDAgent):
    """
    ...
    def __init__(
        ...
        Args:
            ...
            stop_loss_percentage: 損失確定パーセンテージ
            trailing_stop_percentage: トレーリングストップロスパーセンテージ（Noneの場合は無効）
        """
